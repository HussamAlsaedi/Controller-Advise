...
public class RequestPropertyController {
   ...
   // add and send mail to owner
    @PostMapping("/add")
    public ResponseEntity<ApiResponse> addRequestProperty(@RequestBody @Valid RequestProperty requestProperty) {
    ...
    public ResponseEntity<ApiResponse> updateRequestProperty(@PathVariable Long requestPropertyId ,
                                                             @RequestBody @Valid RequestProperty requestProperty) {
