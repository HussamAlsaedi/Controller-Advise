...
public class PropertyController {
    ...
    @PostMapping("/add")
    public ResponseEntity<ApiResponse> addProperty(@RequestBody @Valid Property property) {
    ...
    public ResponseEntity<ApiResponse> updateProperty(@PathVariable Long propertyId,
                                                      @RequestBody @Valid Property updatedProperty ) {
