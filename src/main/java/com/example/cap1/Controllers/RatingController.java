...
public class RatingController {
    ...
    @PostMapping("/add")
    public ResponseEntity<ApiException> addRating(@RequestBody @Valid Rating rating) {
    ...
    public ResponseEntity<ApiException> updateRating(@PathVariable Long ratingId,
