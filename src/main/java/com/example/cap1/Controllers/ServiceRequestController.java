...
public class ServiceRequestController {
    ...
    @PostMapping("/add")
    public ResponseEntity<ApiResponse> addServiceRequest(@RequestBody @Valid ServiceRequest serviceRequest) {
    ...
    public ResponseEntity<ApiResponse> updateServiceRequest(@PathVariable Long RequestId, @RequestBody @Valid ServiceRequest serviceRequest) {
