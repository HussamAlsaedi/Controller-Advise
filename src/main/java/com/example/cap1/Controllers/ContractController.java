...
public class ContractController {
    ...
    @PostMapping("/add")
    public ResponseEntity<ApiResponse> addContract(@RequestBody Contract contract) {
    ...
    public ResponseEntity<ApiResponse> updateContract(@PathVariable Long ContractId, @RequestBody @Valid Contract updatedContract) {
